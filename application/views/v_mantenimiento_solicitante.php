...
<html lang="en">
    ...
    <body onload="cargar_lista_solicitante()">
        ...
        <div id="container" class="container space_top">    
            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span6">
                        <form class="form-inline">
                            <label class="LabelForm">Ruc:</label>
                            <input type="text" id="inputruc" class="" placeholder="">
                        </form>
                        <form class="form-inline">
                    ...
                    <div class="span6">
                        <form class="form-inline">
                            ...
                            <input type="text" class="" id="inputdireccion" >
                        </form> 
                        <form class="form-inline">
             ...
             <form class="form-inline">
                 <button type="button" class="btn btn-primary" onclick="registrar_solicitante();">Registrar solicitante</button>
            </form>
            </div>
            <br>
            <h4>Lista de solicitantes</h4>
            <hr><br>
            <div class="container-fluid">
        ...
        <script src="<?php echo base_url(); ?>js/propio/solicitante.js"></script>
...
<div style="width: 1000px;margin-left: -498px;" id="ModalEditarUsuario" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-header">
        ...
        <h3 id="myModalLabel">Editar Solicitante</h3>
    </div>
        ...
        <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span6">
                        <form class="form-inline">
                            <label class="LabelForm">Ruc:</label>
                            <input type="text" id="inputruc1" class="" placeholder="" disabled>
                        </form>
                        <form class="form-inline">
                            <label class="LabelForm" for=''>Nombre:</label>
                    ...
                    <div class="span6">
                        <form class="form-inline">
                            <label class="LabelForm">Dirección:</label>
                            <input type="text" class="" id="inputdireccion1" >
                        </form> 
                        <form class="form-inline">
                            <label class="LabelForm">teléfono:</label>
    ...
    <div class="modal-footer">
        <button class="btn" id="ModalEditar"  onclick="update_solicitante()">Editar</button>
    </div>
</div>