                ...
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <form class="form-inline">
                            ...
                            <input type="text" class="" id="inputFdesde" value="<?php echo $fechad->format('d/m/Y');
                        ;
                        ?>" autocomplete="off">
                        </form>
                        <form class="form-inline">
                        ...
                        <form class="form-inline">
                            <label class="LabelForm" for=''>Operador:</label>
                            <select id="selectAsunto" ><?php echo $LIdUsuarios; ?></select>
                            <button type="button" id="BtnConsultar" class="btn btn-primary" onclick="consultaxoperador()">Consultar</button>                            
                        </form>
                    </div>                    
                    ...
                    <form class="form-inline">
                        <button type="button" id="BtnreporteOperador" class="btn">Generar reporte</button>
                    </form>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#BtnreporteOperador").click(function() {
            fd = $('#inputFdesde').val();
            fh = $('#inputFhasta').val();
            param = $('#selectAsunto').val();
            url = $(this).attr("href");
            cadena = '<?php echo base_url(); ?>index.php/c_reporte/documento_usuario?fd='+fd+'&fh='+fh+'&param='+param;
