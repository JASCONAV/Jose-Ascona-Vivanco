            ...
            <div class="container-fluid">
                <div class="row-fluid">
                    <div class="span6">
                        ...
                        <form class="form-inline">
                            <label class="LabelForm" for=''>Tipo Carga:</label>
                            <select id="selectCarga" ><?php echo $lista_areas; ?></select>
                            <button type="button" id="BtnConsultarTipoCarga" class="btn btn-primary" onclick="consultaxtipoCArga()">Consultar</button>
                        </form>
                    </div>
                    ...
                    <form class="form-inline">
                        <button type="button" id="BtnreporteCarga" class="btn">Generar reporte</button>
                    </form>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        $("#BtnreporteCarga").click(function() {
            fd = $('#inputFdesde').val();
            fh = $('#inputFhasta').val();
            param = $('#selectCarga').val();
            url = $(this).attr("href");
            cadena = '<?php echo base_url(); ?>index.php/c_reporte/carga?fd='+fd+'&fh='+fh+'&param='+param;
